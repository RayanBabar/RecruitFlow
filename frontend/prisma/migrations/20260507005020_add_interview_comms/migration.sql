...
-- AddForeignKey
ALTER TABLE "ApplicationAction" ADD CONSTRAINT "ApplicationAction_applicationId_fkey" FOREIGN KEY ("applicationId") REFERENCES "Application"("id") ON DELETE CASCADE ON UPDATE CASCADE;
